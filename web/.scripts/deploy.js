// Build locally + rsync to /var/www/almanac-web + pm2 reload.
...
const DEST = process.env.SERVER_DEST_PATH || '/var/www/almanac-web';
const PM2 = process.env.SERVER_PM2_PROCESS || 'inkwell-web';
