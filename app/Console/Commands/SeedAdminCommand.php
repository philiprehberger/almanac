...
#[Signature('almanac:seed-admin {--email=} {--name=Admin} {--password=} {--workspace=Default Workspace}')]
...
class SeedAdminCommand extends Command
{
    public function handle(): int
    {
        ...
        $workspace = Workspace::firstOrCreate(
            ...
            ['name' => $workspaceName, 'monthly_budget_usd' => 50.00],
        );
        ...
        WorkspaceMembership::firstOrCreate(
            ...
            ['role' => WorkspaceMembership::ROLE_ADMIN, 'capabilities' => []],
        );
